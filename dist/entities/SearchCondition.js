...
class SearchCondition extends BaseCommon_1.BaseCommon {
    constructor() {
        super(...arguments);
        this.page = 1;
        this.limit = 10;
...
__decorate([
    class_validator_1.IsInt({ message: "页码数必须是整数" }),
    class_validator_1.Min(1, { message: "页码数不能够小于1" }),
    class_transformer_1.Type(() => Number),
    __metadata("design:type", Number)
], SearchCondition.prototype, "page", void 0);
__decorate([
    class_validator_1.IsInt({ message: "页容量必须是整数" }),
    class_validator_1.Min(1, { message: "页容量不能够小于1" }),
    class_transformer_1.Type(() => Number),
    __metadata("design:type", Number)
